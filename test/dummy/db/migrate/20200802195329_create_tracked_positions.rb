...
class CreateTrackedPositions < ActiveRecord::Migration[6.0]
  def change
    create_table :collab_tracked_positions do |t|
      ...
      t.index      %i[document_id deleted_at_version pos], name: 'index_collab_tracked_positions_on_document_pos'
      t.index      %i[owner_type name owner_id], name: 'index_collab_tracked_positions_on_owner'
    end
  end
end
