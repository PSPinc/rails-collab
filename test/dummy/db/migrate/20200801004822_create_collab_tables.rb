...
class CreateCollabTables < ActiveRecord::Migration[6.0]
  def change
    create_table :collab_documents do |t|
      ...
      t.index %i[attached_type attached_id attached_as], name: 'index_collab_documents_on_attached'
    ...
    create_table :collab_commits, id: false do |t|
      ...
      t.index      %i[document_id document_version], unique: true, order: { document_version: :asc },
                                                     name: 'index_collab_commits'
