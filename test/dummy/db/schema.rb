...
ActiveRecord::Schema.define(version: 20_200_803_004_606) do
  ...
  create_table 'collab_commits', id: false, force: :cascade do |t|
    ...
    t.index %w[document_id document_version], name: 'index_collab_commits', unique: true
  end
  ...
  create_table 'collab_documents', force: :cascade do |t|
    ...
    t.index %w[attached_type attached_id attached_as], name: 'index_collab_documents_on_attached'
  end
  ...
  create_table 'collab_tracked_positions', force: :cascade do |t|
    ...
    t.index %w[document_id deleted_at_version pos], name: 'index_collab_tracked_positions_on_document_pos'
    t.index %w[owner_type name owner_id], name: 'index_collab_tracked_positions_on_owner'
  end
